...
- Meet the requirements for Part 1 of the assignment (HTML structure, navigation, content, and documentation).  
- Lay the foundation for styling (Part 2) and server‑side features (Part 3).  

## Key Features
- **Home:** Latest articles and featured content.  
- **About Us:** Background, vision, and readership.  
- **News:** City developments, events, and community updates.  
- **Things To Do:** Attractions, outdoor activities, and cultural experiences with images.  
- **Membership / Order Form:** Subscription/order form posting to `submit_order.php`.  
